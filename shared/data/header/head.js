                  ...
                  <Dropdown className="header-search">
                    ...
                    <Dropdown.Menu className="p-2">
                      ...
                      <InputGroup className="">
                        <Form.Control type="search" className="form-control rounded-0" placeholder="rECHERCHER UNE SECTION..." onChange={(ele=>{myfunction(ele.target.value); setInputValue(ele.target.value)})} onClick={()=>{setShow1(true)}} />
                  ...
                  <Dropdown className="main-profile-menu">
                    ...
                    <Dropdown.Menu style={{ margin: "0px" }}>
                      <div className="header-navheading">
                        ...
                        <p className="main-notification-text">Poste/Responsabilité</p>
                      </div>
                      
                      <Dropdown.Item
                        className="border-top">
                        <Link href={`/components/pages/profile/`}>
                        <i className="fe fe-user"></i> Mon Profil
                      </Link>
                      </Dropdown.Item>
                      <Dropdown.Item
                      >
                      <Link href={`/components/pages/profile/`}>
                        <i className="fe fe-edit"></i> Modifier Profil
                      </Link>
                      </Dropdown.Item>
                      <Dropdown.Item
                      >
                      <Link href={`/components/pages/profile/`}>
                        <i className="fe fe-settings"></i>Parametre de compte
                      </Link>
                      </Dropdown.Item>
                      {/* <Dropdown.Item */}
                      ...
                      <Dropdown.Item>
                      <Link href={`/components/pages/profile/`}>
                        <i className="fe fe-compass"></i> Activité
                      </Link>
                      </Dropdown.Item>
                      <Dropdown.Item>
                      <Link href={`/components/authentication/signin/`}>
                        <i className="fe fe-power"></i> Deconnexion
                      </Link>
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
